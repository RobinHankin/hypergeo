...
/* .Call calls */
extern SEXP hypergeo_complex_gamma(SEXP);
extern SEXP hypergeo_complex_gamma_cpp(SEXP, SEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"hypergeo_complex_gamma",                (DL_FUNC) &hypergeo_complex_gamma,                 1},
    {"hypergeo_complex_gamma_cpp",            (DL_FUNC) &hypergeo_complex_gamma_cpp,             2},
